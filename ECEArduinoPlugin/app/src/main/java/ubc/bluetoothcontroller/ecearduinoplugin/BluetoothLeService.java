...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =
            "bluetoothcontroller.ubc.bluetooth.le.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            "bluetoothcontroller.ubc.bluetooth.le.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            "bluetoothcontroller.ubc.bluetooth.le.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE =
            "bluetoothcontroller.ubc.bluetooth.le.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA =
            "bluetoothcontroller.ubc.bluetooth.le.EXTRA_DATA";

    public final static UUID UUID_TX_CHARACTERISTIC =
            UUID.fromString(SampleGattAttributes.TX_CHARACTERISTIC);
    ...
    public void writeRXCharacteristic(byte[] value) {
        BluetoothGattService UARTService = mBluetoothGatt.getService(UUID_UART_SERVICE);
        if (UARTService == null) {
            Log.e(TAG, "UARTService not found");
            return;
        }
        ...
        Log.d(TAG, "Wrote RX characteristic, status = " + status);
    }
